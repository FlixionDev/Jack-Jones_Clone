...
export const accessoriesAction = (dispatch) => {
    ...
    const fetchAccessoriesData = () => {
        fetch(`https://curious-hare-jewelry.cyclic.app/accessories`).then((res) => { return res.json() }).then((data) => {
            dispatch({
                type: "accessories",
                payload: data
            })
...
export const clothingAction = (dispatch) => {
    ...
    const fetchClothingData = () => {
        fetch(`https://curious-hare-jewelry.cyclic.app/clothings`).then((res) => { return res.json() }).then((data) => {
            dispatch({
                type: "clothing",
                payload: data
            })
...
export const footwearAction = (dispatch) => {
    ...
    const fetchFootwearData = () => {
        fetch(`https://curious-hare-jewelry.cyclic.app/footwears`).then((res) => { return res.json() }).then((data) => {
            dispatch({
                type: "footwear",
                payload: data
            })
...
export const innerwearAction = (dispatch) => {
    ...
    const fetchInnerwearData = () => {
        fetch(`https://curious-hare-jewelry.cyclic.app/innerwears`).then((res) => { return res.json() }).then((data) => {
            dispatch({
                type: "innerwear",
                payload: data
            })
